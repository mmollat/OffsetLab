    ...
    <main className="min-h-[calc(100vh-73px)] bg-black">
      <section className="mx-auto flex max-w-6xl flex-col items-center px-6 py-20 text-center md:py-28">
        ...
        <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:justify-center">
          ...
          <Link
            href="/torque"
            className="rounded-2xl border border-red-500/30 bg-red-500/10 px-7 py-3.5 font-semibold text-red-400 transition hover:border-red-500/60 hover:bg-red-500/15"
          >
            Torque Hub
          </Link>
        </div>
