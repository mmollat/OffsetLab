...
export const galleryExamples: Record<ModelKey, Record<StyleKey, GalleryBuild[]>> = {
  ...
  "M4": {
    ...
    flush: [pending("G82/G83 M4 Flush Verified Photo Pending", "20x10 ET15 / 20x11 ET15", "285/30R20 / 305/30R20", "BMW M4 flush should show a strong filled-out street stance without overdoing it.", ["BMW", "M4", "G82", "G83", "Flush", "Strict Match"])],
    aggressive: [pending("G82/G83 M4 Aggressive Verified Photo Pending", "20x10 ET12 / 20x11 ET12", "285/30R20 / 305/30R20", "BMW M4 aggressive should only show wide, planted fitment when correctly verified.", ["BMW", "M4", "G82", "G83", "Aggressive", "Strict Match"])],
  },
};
