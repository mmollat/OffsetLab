  ...
  "Model 3": [
    {
      ...
      presets: {
        oemplus: p("OEM+ Setup", "Clean daily setup", "20x8.5 +35", "20x8.5 +35", "235/35R20", "235/35R20", "+7mm", "+7mm", "-1mm", "-1mm", "+0.3%", 4, 9, "Low", "Clean OEM+ fitment with minimal compromise.", "low",),
