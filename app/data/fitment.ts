...
"Supra": [
  ...
  "S2000": [
  {
    ...
    presets: {
      oemplus: p(
        "OEM+ Setup",
        "Clean factory-plus staggered fitment",
        "17x8 +50",
        "17x9 +60",
        "225/45R17",
        "255/40R17",
        ...
        9,
        "Low",
        "Clean S2000 OEM+ setup with a fuller staggered stance while staying daily-friendly.",
        low,
        "17x7.5 +48 / 17x8.5 +58 for a safer OEM+ staggered setup"
      ),
      flush: p(
        "Flush Setup",
        "Lowered street fitment",
        "17x8.5 +48",
        "17x9.5 +55",
        "225/45R17",
        "255/40R17",
        ...
        8,
        "Low / Moderate",
        "Balanced flush S2000 fitment that stays within the platform’s high-offset sweet spot.",
        mod,
        "17x8.5 +50 / 17x9.5 +58 for a safer flush setup"
      ),
      aggressive: p(
        "Aggressive Setup",
        "Track-inspired high-offset stance",
        "17x9 +45",
        "17x9.5 +55",
        "235/40R17",
        "255/40R17",
        ...
        6,
        "Moderate",
        "Aggressive S2000 fitment with a wider front and clean rear stance while avoiding excessive low-offset poke.",
        [
          "Alignment and ride height matter.",
          "Fender roll may be needed if lowered.",
          "Avoid going much lower than +43 front unless using a narrow tire.",
        ],
        "17x9 +45 square with 235/40R17 for a simpler track-style setup"
      ),
    },
  },
],
