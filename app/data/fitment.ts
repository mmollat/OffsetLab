...
"Supra": [
  ...
  8,
  "Low / Moderate",
  "S2000 sweet spot fitment. Clean, dialed stance with excellent daily drivability.",
  mod,
  "17x9 +48 / 17x9.5 +58 for a slightly more conservative flush setup"
),
      aggressive: p(
  "Aggressive Setup",
  ...
  6,
  "Moderate / High",
  "True aggressive S2000 fitment using wider wheels and lower offsets for a more planted, track-inspired stance.",
  [
    "Front camber recommended.",
    "Rear fender roll likely needed.",
    "Dialed ride height required.",
    "Check inner clearance at full lock.",
  ],
  "17x9 +45 / 17x9.5 +50 for a safer aggressive street setup"
),
    },
  },
],
