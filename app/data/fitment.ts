  ...
  "S2000": [
    {
      ...
      presets: {
        oemplus: p(
          ...
          low,
          "17x7.5 +48 square for a Spoon-style OEM+ look"
        ),
        flush: p(
          "Flush Setup",
          ...
          8,
          "Low / Moderate",
          "Balanced flush S2000 fitment with strong visual presence and realistic daily usability.",
          mod,
          "17x9 +45 square with 245/40R17 for a more performance-focused setup"
        ),
        aggressive: p(
          "Aggressive Setup",
          "Max grip / track-inspired stance",
          "17x9 +45",
          "17x10 +50",
          "245/40R17",
          "255/40R17",
          ...
          6,
          "Moderate / High",
          "Aggressive S2000 setup with serious grip and stance. Best for lowered cars with alignment and fender clearance dialed in.",
          [
            "Fender roll recommended.",
            "Negative camber recommended.",
            "Check front clearance carefully, especially at full lock.",
          ],
          "17x9 +45 square with 235/40R17 for a safer aggressive setup"
        ),
      },
    },
  ],
