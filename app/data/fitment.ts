...
function p(
  ...
  return { title, subtitle, front, rear, frontTire, rearTire, pokeFront, pokeRear, innerFront, innerRear, diameter, aggression, daily, risk, verdict, warnings, alternate };
}
...
export const fitmentData: Record<ModelKey, TrimData[]> = {
  ...
  "Model S": [
    ...
    },
    {
      ...
      presets: {
        oemplus: p("OEM+ Setup", "Subtle OEM-adjacent improvement", "20x9 +35", "20x10 +40", "245/40R20", "285/35R20", "+6mm", "+6mm", "-6mm", "-6mm", "+0.4%", 4, 9, "Low", "OEM+ option that keeps the Model S elegant.", low, "21x9 +35 / 255/35R21"),
        flush: p("Flush Setup", "Balanced stance", "21x9 +30", "21x10.5 +35", "255/35R21", "295/30R21", "+11mm", "+18mm", "-1mm", "-8mm", "+0.2%", 7, 8, "Low / Moderate", "A properly filled-out Model S setup.", mod, "20x9.5 +30 / 265/35R20"),
        aggressive: p("Aggressive Setup", "More visual impact", "21x9.5 +28", "21x10.5 +30", "265/35R21", "295/30R21", "+18mm", "+23mm", "-8mm", "-3mm", "+0.7%", 8, 7, "Moderate", "Aggressive daily Model S fitment.", mod, "20x10 +30 / 275/35R20"),
      },
    },
  ],
  ...
  "Model X": [
    ...
    },
    {
      ...
      presets: {
        oemplus: p("OEM+ Setup", "Slightly sharper SUV fitment", "20x9.5 +35", "20x10.5 +35", "265/45R20", "285/40R20", "+6mm", "+6mm", "-6mm", "-6mm", "+0.2%", 4, 9, "Low", "OEM+ Model X setup.", low, "22x9.5 +35 / 265/35R22"),
        flush: p("Flush Setup", "Balanced premium SUV stance", "22x9.5 +30", "22x10.5 +32", "265/35R22", "285/35R22", "+11mm", "+16mm", "-1mm", "-3mm", "+0.6%", 7, 8, "Low / Moderate", "Strong flush stance on Model X.", mod, "20x10 +30 square / 275/40R20"),
        aggressive: p("Aggressive Setup", "Bigger visual impact", "22x10 +28", "22x11 +30", "275/35R22", "305/30R22", "+17mm", "+20mm", "-7mm", "-7mm", "+0.8%", 8, 7, "Moderate", "Aggressive Model X fitment.", mod, "22x10 +30 / 285/35R22"),
      },
    },
  ],
