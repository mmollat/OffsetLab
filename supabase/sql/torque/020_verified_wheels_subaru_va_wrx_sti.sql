...
-- Pack 020: verified Subaru VA WRX/STI wheel lug torque.
--
-- Plain SQL only. Safe to re-run.
-- Updates the Subaru VA WRX/STI wheel lug row from needs_review to verified
-- after checking Subaru's official 2021 WRX/STI Owner's Manual (MSA5M2105A),
-- Flat tires instructions and Tires specifications.
...
with seed(make_slug, model_slug, generation_slug, fastener, torque_ft_lb, torque_nm, source_name, source_url, source_note) as (
  values
    (
      ...
      89,
      120,
      'Subaru 2021 WRX/STI Owner''s Manual (MSA5M2105A)',
      'https://techinfo.subaru.com/stis/doc/ownerManual/MSA5M2105A_STIS-Opt.pdf',
      'Verified from Subaru owner manual MSA5M2105A: Flat tires directs final tightening to the Tires specification table, which lists wheel nut tightening torque as 89 lbf-ft / 120 N-m.'
    )
)
